...
function loadComponents(root = '') {
  ...
  if (mob) mob.innerHTML = `
    ...
    <div class="mob-sub" id="ms1">
      ...
      <a href="${root}qa.html"><svg class="icn" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg> Soalan Lazim (FAQ)</a>
    </div>
